...
import { z } from "zod";
import { a as requireAuth, r as requireAdmin } from "./auth-middleware.server-B9hAjfqi.js";
import { d as db, r as rowsToObjects, h as hashPassword } from "./db-D5OYORU-.js";
import { l as listUsersWithRoles, g as getRoleNameById, f as findUserByEmail, c as createUser, a as grantRole, d as deleteUser, b as getRolesForUser } from "./users.repo-HvqqZq_-.js";
import { listAllProjects, getById, findByOwnerAndName, updateProject, insertProject, setProjectExclusive, deleteProject as deleteProject$1, getProjectExclusive, setBotOffersEnabled, setAllBotOffersEnabled, setOffersEnabled, setAllOffersEnabled, updateProjectExclusivity, searchByName } from "./projects.repo-DX_seSWS.js";
import { searchRequestsByCompany, getRequestByPdfPath, listAllRequests, listPlatformRequests, getRequestById, insertRequest, updateRequestStatus as updateRequestStatus$1 } from "./project-requests.repo-BJrIn2i8.js";
import { listOfferNotificationsBySource, getOfferNotificationById, deleteOfferNotification, updateOfferNotificationStatus, insertOfferNotificationMany } from "./notifications.repo-vog42ua4.js";
import { l as listContactMessages, c as countContactMessagesSince, d as deleteContactMessage, g as getContactMessageById, s as setContactReply } from "./contact-messages.repo-Dqxmkc1I.js";
import { i as isBlocked } from "./blocked.repo-DHutU73k.js";
import { B as BLOCKED_MESSAGE } from "./blocked.functions-pr1NkNVd.js";
import { r as resolveStoredFileUrl } from "./storage-url-BOHLt4ef.js";
import { c as cached, a as cacheKeys, T as TTL_PROJECTS, i as invalidateProjectsAll, b as invalidateQuotes } from "./cache-sw4uQcOM.js";
import { d as detectCity, n as notifyVipSubscribersOfNewProject } from "./vip-notify.server-CM9VcWi6.js";
import { listActiveByCity } from "./vip.repo-CycBrLVA.js";
...
import "./resend-send.server-Cc6n_-h6.js";
function decode(r) {
  let images = [];
  try {
...
const listRoles = createServerFn({
  ...
  } = await import("./db-D5OYORU-.js").then((n) => n.e);
...
const submitBidRequest = createServerFn({
  ...
  try {
    const {
      getSessionClaims
    } = await import("./db-D5OYORU-.js").then((n) => n.b);
  ...
  if (!isAddProject) {
    ...
    if (exclusive && Date.now() < new Date(exclusive.vip_end_at).getTime()) {
      ...
      const {
        validateVipToken,
        consumeVipToken
      } = await import("./vip-notify.server-CM9VcWi6.js").then((n) => n.v);
