...
import { h as hashPassword, d as db, r as rowsToObjects } from "./db-D5OYORU-.mjs";
import { l as listUsersWithRoles, g as getRoleNameById, f as findUserByEmail, c as createUser, a as grantRole, d as deleteUser, b as getRolesForUser } from "./users.repo-HvqqZq_-.mjs";
import { listAllProjects, getById, findByOwnerAndName, updateProject, insertProject, setProjectExclusive, deleteProject as deleteProject$1, getProjectExclusive, setBotOffersEnabled, setAllBotOffersEnabled, setOffersEnabled, setAllOffersEnabled, updateProjectExclusivity, searchByName } from "./projects.repo-DX_seSWS.mjs";
import { searchRequestsByCompany, getRequestByPdfPath, listAllRequests, listPlatformRequests, getRequestById, insertRequest, updateRequestStatus as updateRequestStatus$1 } from "./project-requests.repo-BJrIn2i8.mjs";
import { listOfferNotificationsBySource, getOfferNotificationById, deleteOfferNotification, updateOfferNotificationStatus, insertOfferNotificationMany } from "./notifications.repo-vog42ua4.mjs";
import { l as listContactMessages, c as countContactMessagesSince, d as deleteContactMessage, g as getContactMessageById, s as setContactReply } from "./contact-messages.repo-Dqxmkc1I.mjs";
...
import { d as detectCity, n as notifyVipSubscribersOfNewProject } from "./vip-notify.server-CM9VcWi6.mjs";
  ...
  if (!isAddProject) {
    ...
    if (exclusive && Date.now() < new Date(exclusive.vip_end_at).getTime()) {
      ...
      const {
        validateVipToken,
        consumeVipToken
      } = await import("./vip-notify.server-CM9VcWi6.mjs").then((n) => n.v);
