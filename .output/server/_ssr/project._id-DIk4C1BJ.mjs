...
import { z as Route$r, A as projectQuery, u as useServerFn, D as submitBidRequest, k as getMyRoles, C as getMyVipStatus, h as hasAdminRole, B as getExclusiveStatus } from "./router-pxcAI1C5.mjs";
...
import { P as ProjectStatusBadge, A as AdminProjectStatus } from "./admin-project-status-C3i12czj.mjs";
...
function ProjectDetail() {
  ...
  const vipEndAt = project.vip_end_at ?? null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", dir: "rtl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "container mx-auto px-4 py-10", children: [
      ...
      ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mt-16 max-w-3xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "apply", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6 md:p-10 shadow-[var(--shadow-card)]", children: [
