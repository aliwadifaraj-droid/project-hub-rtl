import { az as CredentialsProviderError, aA as chain, aF as getProfileName, aG as parseKnownFiles } from "../smithy__core.mjs";
...
const resolveLoginCredentials = async (profileName, options, callerClientConfig) => {
  const { fromLoginCredentials } = await import("./credential-provider-login+[...].mjs");
